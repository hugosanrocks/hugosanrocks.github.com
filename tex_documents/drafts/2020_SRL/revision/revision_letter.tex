...
\begin{Answer}
Evidence looking at the surface geololy,
cite the paper from piero \cite{Falcucci2016active} \\
...
\begin{Answer}
we do not know the geometry of the faults and therefore it's difficult tom make this analysis. We can not estimate focal mechanism for very small magnitude events... we can not know the geometry... no coulomb analysis.
\Assignment{Hugo} \WorkInProgressRevTask
\end{Answer}
%
%
