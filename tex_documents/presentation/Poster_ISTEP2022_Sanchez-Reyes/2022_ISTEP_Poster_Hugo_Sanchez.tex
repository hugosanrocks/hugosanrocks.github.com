...
\hskip -0.3cm \includegraphics[width=1\linewidth]{images/model.pdf}
\vskip 0.3cm
\begin{center}
...
\vskip 0.1cm \includegraphics[width=1\linewidth]{images/tests_shmax340}
\end{minipage} 
...
\includegraphics[width=0.94\linewidth]{images/horizontal_delta_00018_fix.png} 
\end{minipage}\\
\begin{minipage}{0.48\linewidth}
 \centering {\bf Fault not fixed ($\mu_s=0.6$)}
...
\begin{minipage}{0.48\linewidth}
 \centering {\bf Fault fixed ($\mu_s=50.0$)}
\includegraphics[width=0.94\linewidth]{images/horizontal_delta_00080_fix.png} 
\end{minipage}\\
