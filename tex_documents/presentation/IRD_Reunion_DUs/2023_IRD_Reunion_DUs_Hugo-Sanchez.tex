...
\begin{minipage}{0.5\linewidth}
  \hskip -3cm	\animategraphics[autoplay,loop,width=1.7\textwidth]{1}{images/video_jump/fig_0}{00}{00} 
\end{minipage}
...
\begin{minipage}{0.5\linewidth}
  \hskip -3cm	\animategraphics[autoplay,loop,width=1.7\textwidth]{1}{images/video_jump/fig_0}{00}{00} %27 
\end{minipage}
\begin{minipage}{0.48\linewidth}
\vskip -0.7cm Caractéristiques en exploration :
\vskip 0.1cm
